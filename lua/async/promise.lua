-- This codes ported from https://raw.githubusercontent.com/hjmmc/lua-promise/master/lua-promise.lua
-- @see https://github.com/hjmmc/lua-promise/blob/master/LICENSE
